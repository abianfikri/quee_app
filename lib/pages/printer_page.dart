...
import 'package:quee_app/pages/widgets/menu_printer_button.dart';
import 'package:quee_app/pages/widgets/menu_printer_content.dart';
...
class _PrinterPageState extends State<PrinterPage> {
  ...
  Future initPlatformState() async {
    ...
    int porcentbattery = 0;

    try {
      platformVersion = await PrintBluetoothThermal.platformVersion;

      porcentbattery = await PrintBluetoothThermal.batteryLevel;
  ...
  Future connect(String mac) async {
    setState(() {
      connected = false;
    });
  ...
  Future disconnect() async {
    ...
    print("status disconnecy $status");
  }
